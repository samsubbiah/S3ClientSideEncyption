...
public class S3Uploader {
    ...
    public void uploadToS3UsingEncryption() {
        ...
        try {
            ...
            String origContent = "S3 Encrypted Object Using KMS-Managed Customer Master Key Jan 7.";

            logger.info("origContent: " + origContent);
